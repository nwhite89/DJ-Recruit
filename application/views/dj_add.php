<div class="container">
    <div class="row">
        <div class="span12">
            ...
            echo form_open('djs/add', $attributes); ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="address_line1" type="text" name="address_line1"  value="<?php echo set_value('address_line1'); ?>"  />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="address_line2" type="text" name="address_line2"  value="<?php echo set_value('address_line2'); ?>"  />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="town" type="text" name="town"  value="<?php echo set_value('town'); ?>"  />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="postcode" type="text" name="postcode"  value="<?php echo set_value('postcode'); ?>"  />
                </div>
            </div>
